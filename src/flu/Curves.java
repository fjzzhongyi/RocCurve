...
public class Curves {
	...
	private static void init() {
		File file_gasdm = new File("data//flu//new//GASDM-result-flu.txt");
		File file_nphgs = new File("data//flu//new//NPHGS-result-flu.txt");
		File file_eventtree = new File("data//flu//new//EventTree-result-flu.txt");
		File file_lgta = new File("data//flu//new//LGTA-result-flu.txt");
		File file_fss = new File("data//flu//new//res_bool.txt");
		File file_real = new File("data//flu//new//TrueLable-flu.txt");
		...
		gasdm = new int[230][10];
		nphgs = new int[230][10];
		eventtree = new int[230][10];
		lgta = new int[230][10];
		fss = new int[230][10];
		real = new int[230][10];
		try {
