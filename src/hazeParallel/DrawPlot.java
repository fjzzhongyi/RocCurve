...
public class DrawPlot extends ApplicationFrame {
    ...
    public DrawPlot(final String title,final String x_label,final String y_label,ArrayList<Point> gasdm,ArrayList<Point> nphgs
    		,ArrayList<Point> eventtree, ArrayList<Point> pasd) {
        super(title);
        final XYDataset dataset = createDataset(gasdm, nphgs, eventtree, pasd);
    ...
    private XYDataset createDataset(ArrayList<Point> gasdm, ArrayList<Point> nphgs, ArrayList<Point> eventtree, 
    		ArrayList<Point> pasd) {
    	final XYSeries series1 = new XYSeries("ASD");
        ...
        final XYSeries series4 = new XYSeries("PASD");
        for(int i=0;i<pasd.size();i++)
        	series4.add(pasd.get(i).x, pasd.get(i).y);
    ...
    public static void draw(final String title,final String x_label,final String y_label,ArrayList<Point> gasdm, 
        ...
        final DrawPlot demo = new DrawPlot(title,x_label,y_label,gasdm, nphgs, eventtree, pasd);
        demo.pack();
